...
# These imports allow us to access SparkML features specific to linear
# regression as well as the Vectors types.
from datetime import datetime
from pyspark.ml.linalg import Vectors
from pyspark.ml.regression import LinearRegression

# Create a SparkSession so this can be submitted as a Dataproc job.
...
# Use Cloud Dataproc's automatically propagated configurations to get
